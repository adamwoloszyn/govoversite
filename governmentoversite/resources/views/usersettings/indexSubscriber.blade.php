                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mt-4 mb-4">
                        ...
                        @if($user_subscription)
                            <input type="hidden" id="txtCustomerNumber" value="{{$user->customer}}" />
                            ...
                            <p>
                                ...
                                @if (strtotime($user_subscription) < strtotime(now()))
                                    {{-- The current date is past the target date --}}
                                    Your subscription has expired on {{ $user_subscription->end_date }}
                                    <button id="btnManageSubscription" type="button" class="p-2 pe-3 ps-3 btn btn-outline-info w-30 inline-block me-2">Manage Subscription</button>
                                @else
                                    {{-- The current date is not past the target date --}}
    ...
    <script language="javascript">
        ...
        $(document).ready(function() {
            ...
            $('#btnGoToStripe').click(function() {
                ...
                $.ajax({
                    url: 'http://127.0.0.1:8000/billing/portal',
                    type: 'POST',
                    data: payload,
                    headers: headers,
